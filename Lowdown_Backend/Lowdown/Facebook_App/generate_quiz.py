...
QUESTION_AMOUNTS = {
    ...
    LikedPagesQuestion : 0,
    LikedStatusQuestion : 0,
    MostTaggedWithQuestion : 0,
    MostUsedWordQuestion : 0,
    PhotoCaptionQuestion : 0,
    PhotoCommentQuestion : 0,
    PhotoLocationQuestion : 0,
    StatusQuestion : 0,
